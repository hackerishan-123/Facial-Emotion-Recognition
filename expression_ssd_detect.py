...
image_std = 128.0
iou_threshold = 0.3 #IOU (Intersection over Union) threshold for determining the overlap between predicted and ground truth bounding boxes.
center_variance = 0.1
size_variance = 0.2
min_boxes = [
    [10.0, 16.0, 24.0], 
...
def define_img_size(image_size):
    shrinkage_list = []#The strides determine the spatial resolution of the feature maps.
